...
namespace ServicioWebTest2.Controllers
{
    public class EditorialController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Editorial,Nombre_Editorial")] Editorial editorial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Editorial,Nombre_Editorial")] Editorial editorial)
        {
            if (ModelState.IsValid)
            {
